			...
			<Stack>
				<StackItem width="50%" md-width="100%">
					...
					>
						...
						<Text as="p" margin="6px 0" font="--headline3">
							<Link href="mailto:encyptextteam@gmail.com" text-decoration="none" hover-text-decoration="underline" color="--light">
								encryptexteam@gmail.com
							</Link>
						</Text>
					</Box>
				...
				<StackItem width="50%" md-width="100%">
					...
					>
						...
						<Formspree endpoint="https://formspree.io/f/mvovbeno" completeText="Welcome to the team! please wait for us to send you the free tryout dates">
							<Stack gap="16px">
								<StackItem width="100%">
									<Override slot="StackItemContent" flex-direction="column" />
